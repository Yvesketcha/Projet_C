...
int main()
{
    ...
    switch(choix){
        ...
        case 1:{
            ...
            CommencerJeu(Theme[Themechoisi - 1], gridsize, gridsize, nomjoueur);//Appel de la fonction commencerjeu pour la lancer la partie
            break;
        }
        case 2:{
            //printf("Bonjour\n");
        ...
        case 3:{
            ...
            printf("\n*==============================================*Veuillez effectuer votre choix*======================================================*\n");
            int Themechoisi;
            char *Theme[] = {"Animaux", "Pays", "Afrique"};//Definir un pointeur de tableau
            int nbTheme = sizeof(Theme) / sizeof(Theme[0]);
            printf("Veuillez choisir un theme: \n");
            for(int i = 0; i < nbTheme; i++){
                printf("%d.%s\n", i + 1, Theme[i]);
            ...
            snprintf(cheminFichier, sizeof(cheminFichier), "%s%s", chemin_base, Theme[Themechoisi - 1]);
            CommencerJeu(Theme[Themechoisi - 1], lignes, colonnes, nomjoueur);//Appel de la fonction commencerjeu pour la lancer la partie
            break;
        }
